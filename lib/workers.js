...
workers.alertUserToStatusChange = function(newCheckData){
    ...
    helpers.sendMailgunEmail(newCheckData.userEmail,msg,function(err){
      if(!err){
        debug("Success: User was alerted to a status change in their check, via email: ",msg);
      } else {
        debug("Error: Could not send email alert to user who had a state change in their check",err);
      }
    });
  };
